...
\begin{document}
	...
	\subsection{Probabilistische Netze}
	Theorem von Bayes behandelt alle Symptome als voneinander unabhängig. Probabilistische Netze (gerichtete Graphen) stellen Abhängigkeiten dar.
	
	% TODO continue with chapter 14
